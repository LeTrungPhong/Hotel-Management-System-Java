    ...
    <body class="container">
        ...
        <script type="text/babel">
            function ContentListItemForm(course){
                return (
                    <div className="content__listroom-item">
                        <div className="content__listroom-item-form">
                        <div className="content__listroom-item-form-item">
                            <p className="content__listroom-item-form-item-topic">ID:</p>
                            <p className="content__listroom-item-form-item-text">{course.id}</p>
                        </div>
                        <div className="content__listroom-item-form-item">
                            <p className="content__listroom-item-form-item-topic">Type:</p>
                            <p className="content__listroom-item-form-item-text">{course.TypeRoom}</p>
                        </div>
                        <div className="content__listroom-item-form-item">
                            <p className="content__listroom-item-form-item-topic">View:</p>
                            <p className="content__listroom-item-form-item-text"></p>
                        </div>
                        <div className="content__listroom-item-form-item">
                            <p className="content__listroom-item-form-item-text">{course.Money}</p>
                        </div>
                        </div>
                        <div className="content__listroom-item-check"></div>
                    </div>
                )
            }
